...
import { hasESNodeParentExtension, isESCallExpression, isESVariableDeclarator } from "../parsers/es.js";
import { escapeNestedQuotes } from "../utils/quotes.js";
import { createRuleListener } from "../utils/rule.js";
import { getCommonOptions, splitClasses, splitWhitespaces } from "../utils/utils.js";
...
function lintLiterals(ctx, literals) {
    for (const literal of literals) {
        ...
        const escapedClasses = escapeNestedQuotes(finalChunks.join(""), literal.openingQuote ?? "\"");
        const fixedClasses = [
