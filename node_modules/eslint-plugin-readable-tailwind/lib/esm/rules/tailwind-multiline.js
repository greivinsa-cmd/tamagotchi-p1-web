...
import { isESObjectKey } from "../parsers/es.js";
import { escapeNestedQuotes } from "../utils/quotes.js";
import { createRuleListener } from "../utils/rule.js";
import { display, findLineStartPosition, findLiteralStartPosition, getCommonOptions, splitClasses } from "../utils/utils.js";
...
class Line {
    ...
    toString(indent = true) {
        return this.join([
            ...
            escapeNestedQuotes(this.join(this.classes), this.meta.openingQuote ?? "`"),
